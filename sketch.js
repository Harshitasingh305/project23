...
function setup() {
  ...
  /* rec1=createSprite(350,590, 20,150);
	...
	ground = Bodies.rectangle(width/2, 650, width, 10 , {isStatic:true} );
 	...
 	rec1=createSprite(300,580, 20,140);
	rec1Body= Bodies.rectangle(300,580,20,140,{isStatic:true});
    World.add(world,rec1Body)


    rec3=createSprite(500,580, 20,140);
    rec3Body= Bodies.rectangle(500,580,20,140,{isStatic:true});
    World.add(world,rec3Body)

    rec2=createSprite(390,640, 200,20);
    rec2Body= Bodies.rectangle(390,640,200,20,{isStatic:true});
